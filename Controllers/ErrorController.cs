namespace WebApplication1.Controllers
{
    ...
    public sealed class ErrorController : Controller
    {
        ...
        [OutputCache(CacheProfile = "ResourceNotFound")]
        [Route("index", Name = "ErrorIndex")]
        public ActionResult Index(int statusCode)
        {
            return this.GetErrorView((HttpStatusCode)statusCode, HttpWorkerRequest.GetStatusDescription(statusCode).Replace(" ", ""));
        }
